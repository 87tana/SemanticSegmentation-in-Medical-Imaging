...
class SegmentationDataset():
    def __init__(self, root_dir, df, subset, outputsize, max_samp=None, augment=False):
        ...
        if self.augment:
          ...
          self.transform = deafault_transform(outputsize)
    ...
    def __getitem__(self, idx):
        ...
        if self.augment:
          image, mask = self.transform.augment(image_orig, mask_orig)
        else:
